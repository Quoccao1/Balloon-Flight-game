# -*- coding: utf-8 -*-
"""
Created on Thu Apr 20 22:33:00 2023
...
tree2 = Actor("tree")
tree2.pos =randint(800,1600), 450 #makes the tree appear on the grass at the bottom of the screen
...
def update_high_scores():
    global score, scores
    filename = r"C:/Users/quocc/OneDrive - sjsu.edu/SPRING2023/EE104/Lab7/Balloon Flight/high-scores.txt"
    scores = []
...
def update():
    ...
    global game_over, score, number_of_updates, life  #declares the variables the function must change
    if not game_over:
        if not up:
            balloon.y += 1
